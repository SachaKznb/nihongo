...
const DEFAULT_TEMPLATES: Record<string, EmailTemplate> = {
  ...
  streak_at_risk: {
    type: "streak_at_risk",
    subject: "Ta serie de {{streak}} jours est en danger - Nihongo",
    headline: "Ta serie de {{streak}} jours est en danger",
    bodyText:
      "Bonjour {{username}},\n\nTu as construit une serie de {{streak}} jours consecutifs d'apprentissage. C'est un vrai accomplissement, et ca serait dommage de la perdre maintenant.\n\nUne seule revision suffit pour maintenir ta serie. Ca prend moins de deux minutes, et tu gardes tout l'elan que tu as accumule.\n\nLa regularite est la cle pour apprendre le japonais. Chaque jour compte, meme les jours ou tu n'as pas beaucoup de temps. Fais une revision rapide et ta serie continue.",
    buttonText: "Sauver ma serie",
    footerText: "Ta serie sera remise a zero demain matin si tu ne fais pas au moins une revision aujourd'hui.",
    isActive: true,
