...
export default async function MainLayout({
  ...
  return (
    <div className="min-h-screen bg-stone-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/settings"
                className="hidden sm:block p-2 text-stone-500 hover:text-stone-700 hover:bg-stone-100 rounded-lg transition-colors"
              >
              ...
              {/* User avatar and sign out - hidden on mobile */}
      ...
      {/* Main content */}
      <main className="pattern-overlay min-h-[calc(100vh-4rem)]">{children}</main>
    </div>
  );
}
